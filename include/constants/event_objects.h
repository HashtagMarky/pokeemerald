...
#define OBJ_EVENT_GFX_ALOLA_ACE_M                242
#define OBJ_EVENT_GFX_ALOLA_ACE_F                243
#define OBJ_EVENT_GFX_GLADION                    244
#define OBJ_EVENT_GFX_LILLIE_HAT                 245
#define OBJ_EVENT_GFX_TEAM_SKULL_GRUNT_M         246
#define OBJ_EVENT_GFX_TEAM_SKULL_GRUNT_F         247
...
#define IS_FOLLOWMON_GFXID(gfxID)                (gfxID >= OBJ_EVENT_GFX_FOLLOW_MON_FIRST && gfxID <= OBJ_EVENT_GFX_FOLLOW_MON_LAST)
...
#define OBJ_EVENT_PAL_TAG_ELIO                    0x1131
#define OBJ_EVENT_PAL_TAG_SELENE                  0x1132
