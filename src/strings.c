...
const u8 gText_MenuColorColor[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}COLOR");
const u8 gText_MenuColorNumber[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}");
...
const u8 gText_AutoRunOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}TOGGLE");
const u8 gText_AutoRunOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}HOLD");
