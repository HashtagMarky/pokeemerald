...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_DISABLE_FOLLOWERS          // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
...
#define OW_FLAG_NO_ENCOUNTER        FLAG_OW_NO_ENCOUNTER  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      0  // If this flag is set, trainers will not battle the player unless they're talked to.
#define OW_FLAG_NO_COLLISION        FLAG_NO_COLLISON  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
