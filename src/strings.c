...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_POKERIDE] =     COMPOUND_STRING("RIDE PAGER")
};
...
const u8 gText_AutoRun[] = _("RUN MODE");
const u8 gText_TitleScreen[] = _("TITLE SCREEN");
const u8 gText_TS_Time[] = _("TIME");
const u8 gText_TS_Random[] = _("RANDOM");
const u8 gText_TS_Necrozma[] = _("NECROZMA");
const u8 gText_TS_Solgaleo[] = _("SOLGALEO");
const u8 gText_TS_Lunala[] = _("LUNALA");
const u8 gText_RP_Original[] = _("ORIGINAL");
const u8 gText_RP_Black[] = _("BLACK");
const u8 gText_RP_White[] = _("WHITE");
const u8 gText_RP_Red[] = _("RED");
const u8 gText_RP_Green[] = _("GREEN");
const u8 gText_RP_Blue[] = _("BLUE");
const u8 gText_RP_Yellow[] = _("YELLOW");
const u8 gText_RP_Purple[] = _("PURPLE");
const u8 gText_RP_Rose[] = _("ROSE");
const u8 gText_RP_Turquoise[] = _("TURQUOISE");
const u8 gText_RP_Brown[] = _("BROWN");
const u8 gText_RP_DarkBlue[] = _("DARK BLUE");
const u8 gText_RP_DarkGreen[] = _("DARK GREEN");
const u8 gText_RP_WineRed[] = _("WINE RED");
const u8 gText_RP_Lavender[] = _("LAVENDER");
const u8 gText_RP_Gold[] = _("GOLD");
const u8 gText_MenuColor[] = _("PHONE COLOR");
const u8 gText_MenuColorColor[] = _("COLOR");
const u8 gText_MenuColorNumber[] = _("");
const u8 gText_OW_Encounter[] = _("OVERWORLD {PKMN}");
const u8 gText_OW_Encounter_On[] = _("ON");
const u8 gText_OW_Encounter_Off[] = _("OFF");
...
const u8 gText_FollowerOff[] = _("HIDE");
const u8 gText_FollowerOn[] = _("SHOW");
...
const u8 gText_AutoRunOn[] = _("TOGGLE");
const u8 gText_AutoRunOff[] = _("HOLD");
