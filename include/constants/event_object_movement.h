...
// Tauros fast movement animations (2 ticks per frame for MOVE_SPEED_FASTER)
#define ANIM_TAUROS_FAST_SOUTH (ANIM_STD_COUNT + 4)
#define ANIM_TAUROS_FAST_NORTH (ANIM_STD_COUNT + 5)
#define ANIM_TAUROS_FAST_WEST  (ANIM_STD_COUNT + 6)
#define ANIM_TAUROS_FAST_EAST  (ANIM_STD_COUNT + 7)
