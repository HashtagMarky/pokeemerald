...
#define VERSION_BANNER_Y_GOAL 128
...
static const struct FadeColors sFadeColors_Necrozma[FADE_COLOUR_COUNT] = {
    {
...
const struct TitleScreenGraphics sTitleScreenGraphics[TSP_COUNT_RANDOM] =
{
    [TSP_ULTRA_NECROZMA] =
    {
        ...
        .fadeColors = sFadeColors_Necrozma,
    },
    [TSP_SOLGALEO] =
    {
...
static void StartPokemonLogoShine(u8 mode)
{
    ...
    case SHINE_MODE_SINGLE:
        ...
        spriteId = CreateSprite(&sPokemonLogoShineSpriteTemplate, 0, 75, 0); //68
    ...
    case SHINE_MODE_DOUBLE:
        ...
        spriteId = CreateSprite(&sPokemonLogoShineSpriteTemplate, -80, 75, 0);
        gSprites[spriteId].callback = SpriteCB_PokemonLogoShine_Fast;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_WINDOW;
        break;
    }
...
void CB2_InitTitleScreen(void)
{
    ...
    case 1:
        ...
        // bg3
        DecompressDataWithHeaderVram(sTitleScreenGraphics[sTitleScreenPokemon].gfx, (void *)(BG_CHAR_ADDR(2)));
        DecompressDataWithHeaderVram(sTitleScreenGraphics[sTitleScreenPokemon].tilemap, (void *)(BG_SCREEN_ADDR(26)));
        // bg1
    ...
    case 4:
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_1 // modifying dispcntmode to 0 makes the logo jumbled.
                                    | DISPCNT_OBJ_1D_MAP
                                    | DISPCNT_BG2_ON
                                    | DISPCNT_OBJ_ON
                                    | DISPCNT_WIN0_ON
...
static void Task_TitleScreenPhase3(u8 taskId)
{
    ...
    else
    {
        ...
        SetGpuReg(REG_OFFSET_BG2Y_H, 0); //changing this value to 120 makes the pokemon logo disappear from the title screen, animations still play
