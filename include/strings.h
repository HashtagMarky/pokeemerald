...
extern const u8 gText_PokeRide[];
...
extern const u8 gText_TitleScreen[];
extern const u8 gText_TS_Random[];
extern const u8 gText_TS_Time[];
extern const u8 gText_TS_Necrozma[];
extern const u8 gText_TS_Solgaleo[];
extern const u8 gText_TS_Lunala[];
extern const u8 gText_RP_Original[];
extern const u8 gText_RP_Black[];
extern const u8 gText_RP_White[];
extern const u8 gText_RP_Red[];
extern const u8 gText_RP_Green[];
extern const u8 gText_RP_Blue[];
extern const u8 gText_RP_Yellow[];
extern const u8 gText_RP_Purple[];
extern const u8 gText_RP_Rose[];
extern const u8 gText_RP_Turquoise[];
extern const u8 gText_RP_Brown[];
extern const u8 gText_RP_DarkBlue[];
extern const u8 gText_RP_DarkGreen[];
extern const u8 gText_RP_WineRed[];
extern const u8 gText_RP_Lavender[];
extern const u8 gText_RP_Gold[];
...
extern const u8 gText_Birch_Nameplate[];
