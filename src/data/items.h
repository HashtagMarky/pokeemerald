...
// Misc. Key Items
    ...
    {
        .name = ITEM_NAME("Stoutland Search"),
        .price = 0,
        .description = COMPOUND_STRING(
            "This Stoutland\n"
            "can search for\n"
...
// GEN 9 ITEMS
    ...
    [ITEM_CUT_TOOL] =
    {
        .name = ITEM_NAME("Mudsdale Gallop"),
        .price = 0,
        .importance = 1,
    ...
    [ITEM_FLY_TOOL] =
    {
        .name = ITEM_NAME("Charizard Glide"),
        .price = 0,
        .importance = 1,
        ...
        .iconPalette = gItemIconPalette_PokeRideCharizard,
    },

    [ITEM_SURF_TOOL] =
    {
        .name = ITEM_NAME("Lapras Paddle"),
        .price = 0,
        .importance = 1,
